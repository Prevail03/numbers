                            ...
                            if ($leagues) {
                                foreach ($leagues as $league) {
                                    ...
                                    if ($league['leagueStatus'] == 'Active') {
                                      echo "<td class='text-center text-succes'><span class='badge badge-sm bg-gradient-succes'>".$league['leagueStatus']."</span></td>";
                                    } else {
                                      echo "<td class='text-center text-success'><span class='badge badge-sm bg-gradient-success'>".$league['leagueStatus']."</span></td>";
                                    }
