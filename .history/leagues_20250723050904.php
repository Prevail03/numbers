              ...
              <form action="allforms.php" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name = "leagueName" id="leagueName" placeholder="Enter email">
                  </div>
                  <div class="form-group">
                    <label for="leagueDesc">League Description</label>
                    <input type="text" class="form-control" id="leagueDesc" placeholder="Password">
                  </div>
                  <div class="form-group">
