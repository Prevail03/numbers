                            ...
                            if ($leagues) {
                                foreach ($leagues as $league) {
                                    ...
                                    <td>
                                      <div class="btn-group">
                                        <button type="button"
                                              class="btn btn-primary btn-md edit-league-btn"
                                              data-toggle="modal"
                                              data-target="#edit-league-modal"
                                              data-id="<?php echo $league['insertID']; ?>"
                                              data-name="<?php echo htmlspecialchars($league['leagueName']); ?>"
                                              data-desc="<?php echo htmlspecialchars($league['leagueDesc']); ?>"
                                              data-status="<?php echo $league['leagueStatus']; ?>"
                                              data-gender="<?php echo $league['leagueGender']; ?>"
                                              data-year="<?php echo $league['leagueYear']; ?>">
                                          Edit League
                                        </button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card card-primary">
              ...
              <!-- form start -->
              <form action="allforms.php" method="POST">
                <input type="hidden" name="formName" value="editLeague">
                <input type="hidden" name="insertID" id="insertID" value="">
                <div class="card-body">
                  <div class="form-group">
                    <label for="leagueName">League Name</label>
                    <input type="text" class="form-control" name = "leagueName" id="leagueName" placeholder="KHF 205/2026">
                  ...
                  <div class="form-group">
                    <label for="leagueStatus">League Status</label>
                    <select class="form-control" name="leagueStatus" id="leagueStatus">
...
<script>
  $(document).ready(function () {
    $('.edit-league-btn').on('click', function () {
      const button = $(this);
      ...
      $('#edit-league-modal #leagueName').val(name);
      $('#edit-league-modal #leagueDesc').val(desc);
      $('#edit-league-modal select[name="leagueStatus"]').val(status);
      $('#edit-league-modal select[name="leagueGender"]').val(gender);
      $('#edit-league-modal #leagueYear').val(year);
    });
  });
</script>
