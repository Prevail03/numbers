                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    include_once 'includes/functions.php';
                            ...
                            $clients = readQuery($conn, $query, $params);
                            $i = 1;
                            if ($clients) {
                                foreach ($clients as $client) {
                                    echo "<tr>";
                                    echo "<td>" . $i++ . "</td>";
                                    echo "<td>" . htmlspecialchars($client['leagueName']) . "</td>";
                                    echo "<td>" . htmlspecialchars($client['leagueDesc']) . "</td>";
                                    echo "<td>" . htmlspecialchars($client['leagueStatus']) . "</td>";
                                    echo "<td>" . htmlspecialchars($client['createdBy']) . "</td>";
                                    echo "<td>" . htmlspecialchars($client['updatedBy']) . "</td>";
                                    echo "</tr>";
                                }
                            } else {
