                            ...
                            if ($leagues) {
                                foreach ($leagues as $league) {
                                    ...
                                    if ($league['leagueStatus'] == 'Active') {
                                            echo "<td class='align-middle text-center text-danger'><span class='badge badge-sm bg-gradient-danger'>".$league['leagueStatus']."</span></td>";
                                        } else {
                                            echo "<td class='align-middle text-center text-success'><span class='badge badge-sm bg-gradient-success'>".$league['leagueStatus']."</span></td>";
                                        }
